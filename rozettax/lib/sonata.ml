...
let stack_to_str (s : stack) =
  "[" ^ String.concat ";\n" (List.map sval_to_str s) ^ "]"

let mem_to_str (m : memory) =
...
let store l sv m =
  if List.mem_assoc l m then (l, sv) :: List.remove_assoc l m else (l, sv) :: m
...
let step = function
  ...
  | s, m, e, BOX z :: c ->
      ...
      else (box_stack s z [], m, e, c)
  | V (R r) :: s, m, e, UNBOX x :: c -> (V (L (lookup_record x r)) :: s, m, e, c)
  | V (L l) :: s, m, e, BIND x :: c -> (s, m, (x, Loc l) :: e, c)
  | P p :: s, m, e, BIND x :: c -> (s, m, (x, Proc p) :: e, c)
  | s, m, (x, ev) :: e, UNBIND :: c -> (M (x, ev) :: s, m, e, c)
  | V (L l) :: sv :: P (x, c', e') :: s, m, _e, CALL :: _c ->
      (s, store l sv m, (x, Loc l) :: e', c')
  | s, m, e, GET :: c -> (V (Z (read_int ())) :: s, m, e, c)
  | V (Z z) :: s, m, e, PUT :: c ->
      let _ = print_endline (string_of_int z) in
      (s, m, e, c)
  | V (Z z2) :: V (Z z1) :: s, m, e, ADD :: c -> (V (Z (z1 + z2)) :: s, m, e, c)
  | V (Z z) :: V (L (base, offset)) :: s, m, e, ADD :: c
  | V (L (base, offset)) :: V (Z z) :: s, m, e, ADD :: c ->
      if offset + z >= 0 then (V (L (base, offset + z)) :: s, m, e, c)
      else raise (Error "Negative loc offset spawned")
  | V (Z z2) :: V (Z z1) :: s, m, e, SUB :: c -> (V (Z (z1 - z2)) :: s, m, e, c)
  | V (Z z) :: V (L (base, offset)) :: s, m, e, SUB :: c ->
      if offset - z >= 0 then (V (L (base, offset - z)) :: s, m, e, c)
      else raise (Error "Negative loc offset spanwed")
  | V (Z z2) :: V (Z z1) :: s, m, e, MUL :: c -> (V (Z (z1 * z2)) :: s, m, e, c)
  | V (Z z2) :: V (Z z1) :: s, m, e, DIV :: c -> (V (Z (z1 / z2)) :: s, m, e, c)
  | V v2 :: V v1 :: s, m, e, EQ :: c -> (V (B (is_equal v1 v2)) :: s, m, e, c)
  | V (Z z2) :: V (Z z1) :: s, m, e, LESS :: c -> (V (B (z1 < z2)) :: s, m, e, c)
  | V (B b) :: s, m, e, NOT :: c -> (V (B (not b)) :: s, m, e, c)
  | _s, _m, _e, _c -> raise (Error "Invalid machine state")
